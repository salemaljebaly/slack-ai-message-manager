...
function showExtensionInfo() {
  ...
  console.log('\n📍 Chrome:');
  console.log('   - CORS Unblock: https://chrome.google.com/webstore/detail/cors-unblock/lfhmikememgdcahcdlaciloancbhjino');
  console.log('   - Allow CORS: https://chrome.google.com/webstore/detail/allow-cors-access-control/lhobafahddgcelffkeicbaginigeejlf');
  console.log('\n📍 Firefox:');
  console.log('   - CORS Everywhere: https://addons.mozilla.org/en-US/firefox/addon/cors-everywhere/');
